...
/* GT911 configuration used by the 5.0-inch panel. */
 #define TOUCH_GT911
...
/**
 * @brief Initialize the selected touch controller.
 */
void touch_init()
{
#if defined(TOUCH_FT6X36)
...
/**
 * @brief Return whether the controller can be queried in this iteration.
 */
...
/**
 * @brief Read one touch point and map it to display coordinates.
 *
 * @return true while a finger is detected; false otherwise.
 */
bool touch_touched()
{
#if defined(TOUCH_FT6X36)
...
/**
 * @brief Report a release event for the selected controller.
 */
bool touch_released()
{
#if defined(TOUCH_FT6X36)
